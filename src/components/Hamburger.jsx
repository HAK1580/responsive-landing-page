...
const Hamburger = () => {
  return (
    <div className='border mt-[-0.3rem] bg-gray-200 fixed right-0 mx-auto h-full p-1 w-[80%] ' >
          <ul className='flex flex-col ml-6 mt-5 gap-6'>
            ...
            <li><a className='text-[1.2rem] ham-a' href="/skills">Features</a></li>
            <li><a className='text-[1.2rem] ham-a' href="/projects">Contacts</a></li>
        </ul>
